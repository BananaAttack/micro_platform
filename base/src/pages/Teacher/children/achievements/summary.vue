    ...
    <div style="display: flex;justify-content: center;align-items: center;flex-direction: column;">
        ...
        <div class="head" style="margin-bottom: 20px;">
           ...
           <el-button type="primary"  @click="visibel_confirm_create = false"  >取消</el-button>
            <el-button type="primary" @click.native="$router.push({name:'teacher_report',params:{id:code}})">确定</el-button>
           </div>
                 </el-dialog>
                    <el-dialog
             width="30%"
        ...
        <div class="choose achieve_list">
            <div class="row_1" style="margin-top: 10px;" v-for="(item,i) in base_data" :key="i">
                <div style="overflow: hidden; display: inline">
                    ...
                    <el-checkbox style="display: inline-block;margin-left: 20px;color: gray;font-weight: lighter;"
                    ...
                    <div v-if="item.en!=='achieve_year'" style="display: inline-block;">
                        <el-checkbox-group v-model="selected[item.en]" @change="HandleChecked($event,item.en)"
                            ...
                            <el-checkbox  :disabled="isInd[item.en]===false" :label="item_2" style="display: inline-block;margin-right: 10px;color: gray;font-weight: lighter;">{{item_2}}
                            </el-checkbox>
                            </el-checkbox>
                        </el-checkbox-group>
                    </div>
                    <div v-else style="display: inline-block;">
                        <el-checkbox-group v-model="Selected_achieve_year"
                            ...
                            <el-checkbox   :label="item_2"  :disabled="isInd[item.en]===true" style="display: inline-block;margin-right: 10px;color: gray;font-weight: lighter;">{{item_2}}
                            </el-checkbox>
                        </el-checkbox-group>
            ...
            <div class="row_6" style="margin-top: 10px;">
                <div style="overflow: hidden; display: inline">
                    ...
                    <!-- <el-checkbox v-model="selected.user_id" label=""
                        ...
                        style="display: inline;margin-left: 20px;margin-right: 10px;font-family: helvetica;color: gray;font-weight: lighter;">全选
                    </el-checkbox> -->
                </div>
        ...
        <div class="table">
            <el-table ref="info_export" :data="info" stripe tooltip-effect="dark" size="small" row-key="achieve_id"
                style="width: 100%; margin-top: 30px;cursor:pointer"  @row-click="checkDetails"  @selection-change="info_export = $event" border>
                ...
                <el-table-column prop="work_type" label="作品类型" :formatter="if_null" show-overflow-tooltip align="center"></el-table-column>
                <el-table-column prop="achieve_year" label="年份" :formatter="if_null" show-overflow-tooltip align="center"></el-table-column>
                <el-table-column prop="realName" label="第一作者" :formatter="if_null" show-overflow-tooltip align="center"></el-table-column>
                <el-table-column prop="score" label="计分" :formatter="if_null" show-overflow-tooltip align="center"></el-table-column>
                <!-- <el-table-column prop="team_order" label="队内名次" align="center"></el-table-column> -->
    ...
    export default {
        ...
        methods: {
            ...
            async get_info() {
             ...
             report_detail(row){
               this.$router.push({name:'teacher_report',params:{id:row.code}})
            ...
            async exprot_which(i) {
                if (i == 0) {
                    ...
                    let res = await this.$api_achievement.user_download_pdf(this.$store.getters.user_id);
                    if (res.data.code === 2000) {
            ...
            HandleCheckAll(val, type) {
                ...
                if (type === "name") {
                    ...
                    this.Selected_achieve_year = val ? this.options[type] : [];
                ...
                if(this.isInd[type]===false)
                { this.isInd[type] = true;
                }
                else{ 
            ...
            HandleChecked(value, type, item_2) {
                ...
                if(type==='achieve_type'){ if(this.selected[type].length>1&&this.isInd[type]===true)
                {
                    this.selected[type].shift()
                }}
              else if(type='achieve_year')
              {
                  if(this.Selected_achieve_year.length>1&&this.isInd[type]===false){
                      this.Selected_achieve_year.shift()   
                  }
              }
                this.get_info();
            },
