<template>
  <div v-loading="if_loading">
    <div style="margin-top: 30px;margin-left: 50px;">
      ...
      <div style="width: 80%;">
        <el-steps :active="active" finish-status="success" style="font-family: helvetica;font-size: 16px;" >
      ...
      <div v-if="if_achievements">
        <p style="font-size: 24px;margin-top: 30px;font-family: arial;color: #1f2f3d;font-weight: 400;">成果物信息</p>
        <div style="margin-top: 30px;">
          <el-form  ref="form_achievements" width="500px" :model=form_achievements :rules=form_achievements_rules>
            <el-form-item label="作品名称" :label-width="formLabelWidth" prop="achieve_name" style="font-weight: bold;">
              <el-input v-model="form_achievements.achieve_name" style="width: 400px;"></el-input>
            </el-form-item>
            <el-form-item label="成果类型" :label-width="formLabelWidth" prop="achieve_type" style="font-weight: bold;;">
              <el-radio v-model="form_achievements.achieve_type" label="竞赛">竞赛</el-radio>
              <el-radio v-model="form_achievements.achieve_type" label="项目">项目</el-radio>
              <el-radio v-model="form_achievements.achieve_type" label="论文">论文</el-radio>
              <el-radio v-model="form_achievements.achieve_type" label="荣誉">荣誉</el-radio>
              <el-radio v-model="form_achievements.achieve_type" label="知识产权">知识产权</el-radio>
            </el-form-item>
            <el-form-item  label="成果简介" :label-width="formLabelWidth" prop="achieve_summary" style="font-weight: bold;">
              <el-input type="textarea" :rows="7" maxlength="320" resize="none" style="width: 600px;" v-model="form_achievements.achieve_summary">
              </el-input>
              <span class="numLimit">{{this.form_achievements.achieve_summary.length}}/320</span>
            </el-form-item>
            <el-form-item label="上传支撑材料" :label-width="formLabelWidth" style="font-weight: bold;">
              <el-upload class="upload-demo" style="overflow: hidden;"  action="" :limit="1" :http-request="set_doc" multiple
                :file-list="fileList">
                <el-button slot="trigger" size="small" type="primary" style="display: inline-block;">选取文件</el-button>
              </el-upload>
            </el-form-item>
          </el-form>
          <el-button type="primary" @click="goNext" style="width: 120px;margin-top: 30px;margin-left: 230px;" :loading="if_uploading">下一步</el-button>
        </div>
      ...
      <div v-if="if_competition">
        <div>
        <p style="font-size: 24px;margin-top: 30px;display: inline-block;font-family: arial;color: #1f2f3d;font-weight: 400;">竞赛信息</p>
        </div>
        <div style="margin-top: 30px;">
          <el-form width="500px" :model="form_competition" >
            <el-form-item label="竞赛名称" :label-width="formLabelWidth" style="font-weight: bold;" prop="name">
            ...
            <el-form-item label="作品类型" :label-width="formLabelWidth"style="font-weight: bold;" prop="type">
            ...
            <el-form-item label="年份" :label-width="formLabelWidth"style="font-weight: bold;" prop="year">
              <el-date-picker v-model="form_competition.year" disabled type="year" placeholder="选择年份" format="yyyy" style="width: 400px;">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="公布获奖日期" :label-width="formLabelWidth"style="font-weight: bold;" prop="date">
              <el-date-picker  :picker-options="pickerOptions" v-model="form_competition.award_date" type="date" placeholder="选择获奖日期" format="yyyy-MM-dd"style="width: 400px;">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="获得奖项" :label-width="formLabelWidth"style="font-weight: bold;" prop="award">
          ...
          <el-button type="primary" @click="goNext_members" style="width: 120px;margin-top: 30px;margin-left: 230px;">下一步</el-button>
      ...
      <div v-if="if_projects">
        <div>
        <p style="font-size: 24px;margin-top: 30px;display: inline-block;font-family: arial;color: #1f2f3d;font-weight: 400;">项目信息</p>
        </div>
        <div style="margin-top: 30px;">
          <el-form width="500px">
            <el-form-item label="项目名称" :label-width="formLabelWidth" style="font-weight: bold;">
            ...
            <el-form-item label="作品类型" :label-width="formLabelWidth" style="font-weight: bold;">
            ...
            <el-form-item label="完成进度" :label-width="formLabelWidth" style="font-weight: bold;">
            ...
            <el-form-item label="时间" :label-width="formLabelWidth" style="font-weight: bold;">
              <el-date-picker v-model="form_projects.pro_date" type="date" placeholder="选择时间" value-format="yyyy-MM-dd"style="width:400px">
              </el-date-picker>
            </el-form-item>
          </el-form>
          <el-button type="primary" @click="goNext_members" style="width: 120px;margin-top: 30px;margin-left: 230px;">下一步</el-button>
      ...
      <div v-if="if_paper">
        <div>
        <p style="font-size: 24px;margin-top: 30px;display: inline-block;font-family: arial;color: #1f2f3d;font-weight: 400;">论文信息</p>
        </div>
        <div style="margin-top: 30px;">
          <el-form width="500px">
            <el-form-item label="发布时间" :label-width="formLabelWidth"style="font-weight: bold;">
              <el-date-picker v-model="form_paper.release_date" type="date" placeholder="选择时间" value-format="yyyy-MM-dd"style="width:400px">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="论文类型" :label-width="formLabelWidth"style="font-weight: bold;">
            ...
            <el-form-item label="期刊/会议名" :label-width="formLabelWidth"style="font-weight: bold;">
              <el-input v-model="form_paper.conference_name" style="width: 400px;"></el-input>
            </el-form-item>
            <el-form-item label="级别" :label-width="formLabelWidth"style="font-weight: bold;">
            ...
            <el-form-item label="检索凭证" :label-width="formLabelWidth"style="font-weight: bold;">
          ...
          <el-button type="primary" @click="goNext_members" style="width: 120px;margin-top: 30px;margin-left: 230px;" :loading="if_uploading">下一步</el-button>
          <el-button class="back-el-button" type="primary" @click="goBack" style="width: 120px;margin-top: 30px;margin-left: 30px;">返回</el-button>
        </div>
      ...
      <div v-if="if_patent">
        <div>
        <p style="font-size: 24px;margin-top: 30px;display: inline-block;font-family: arial;color: #1f2f3d;font-weight: 400;">知识产权信息</p>
        </div>
        <div style="margin-top: 30px;">
          <el-form width="500px">
            <el-form-item label="知识产权号" :label-width="formLabelWidth"style="font-weight: bold;">
              <el-input v-model="form_patent.patent_number" style="width: 400px;"></el-input>
            </el-form-item>
            <el-form-item label="知识产权类型" :label-width="formLabelWidth"style="font-weight: bold;">
              <el-select v-model="form_patent.patent_type" placeholder="选择知识产权等级" style="width: 400px;" @change="set_paper_rank">
                <el-option v-for="item in options_patent_type" :key="item.name" :label="item.name" :value="item.name">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="申请时间" :label-width="formLabelWidth"style="font-weight: bold;">
              <el-date-picker v-model="form_patent.apply_date" type="date" placeholder="选择时间" value-format="yyyy-MM-dd"style="width:400px">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="发布时间" :label-width="formLabelWidth"style="font-weight: bold;">
              <el-date-picker v-model="form_patent.grant_date" type="date" placeholder="选择时间" value-format="yyyy-MM-dd"style="width:400px">
              </el-date-picker>
            </el-form-item>
          </el-form>
          <el-button type="primary" @click="goNext_members" style="width: 120px;margin-top: 30px;margin-left: 230px;">下一步</el-button>
      ...
      <div v-if="if_members">
        <div>
        <p style="font-size: 24px;margin-top: 30px;display: inline-block;font-family: arial;color: #1f2f3d;font-weight: 400;">团队信息</p>
        </div>
        <div style="margin-left: 100px;">
          <p style="font-size: 16px;margin-top: 30px;font-weight: bold;color: #808080;">团队成员</p>
          <div style="margin-top: 30px;margin-left: 120px;">

            <draggable v-model="members" @update="datadragEnd" v-bind="{animation:200}">

              <div class="drag-item" v-for="(item,i) in members" :key="item.stid">
            ...
            <div style="margin-top: 30px;">
              ...
              <el-link type="primary" style="display: inline-block;margin-left: 30px;" @click="if_add_firstOrder=!if_add_firstOrder">选择第一负责人</el-link>
            </div>
        ...
        <div  style="margin-left: 100px;">
          <p style="font-size: 16px;margin-top: 30px;font-weight: bold;color: #808080;">指导教师</p>
          <div style="margin-top: 30px;margin-left: 120px;">


            <draggable v-model="teachers" @update="datadragEnd" v-bind="{animation:200}">
              <div class="drag-item" v-for="(item,i) in teachers" :key="item.stid">
                <el-card class="box-card" style="width: 500px;height: 90px;margin-bottom: 20px;">
                  <div style="float: right;margin-top: -10px;">
        ...
        <el-button type="primary" style="width: 120px;margin-top: 30px;margin-left: 230px;" @click="add_achievement">确定</el-button>
        <el-button class="back-el-button" type="primary" @click="goBack" style="width: 120px;margin-top: 30px;margin-left: 30px;">返回</el-button>
      ...
      <el-dialog title="添加团队成员" :visible.sync="visible_add_members" width="600px" @open="cleanAll_members">
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="primary" @click="add_members">确定</el-button>
          <el-button @click="visible_add_members = false">取消</el-button>
        </div>
      </el-dialog>

      <el-dialog title="添加指导老师" :visible.sync="visible_add_teachers" width="600px" @open="cleanAll_teachers">
        <el-form @submit.native.prevent>
          <el-form-item label="学院" :label-width="formLabelWidth">
  ...
  export default {
    ...
    data() {
      return {
        ...
        form_achievements_rules:{
          achieve_name:[
            {required:true,message:'请填写成果名称',trigger:blur}
          ],
          achieve_type:[
            {required:true,message:'请填写成果类型',trigger:blur}
          ],
          achieve_summary:[
    ...
    methods: {
      ...
      goBack(){
        if(this.if_achievements == false && this.if_members == false){
      ...
      goNext() { //进入第二页
      this.$refs['form_achievements'].validate()
      ...
      goNext_members() { //进入第三页
        ...
        if (this.form_achievements.achieve_type == "竞赛") {
          ...
          this.form_projects.year = this.form_projects.pro_date.substr(0,4);
          ...
          this.form_paper.year = this.form_paper.release_date.substr(0,4);
          Object.keys(this.form_paper).forEach(res => {
            if (this.form_paper[res] == ''&& res != 'retrieve') {
              console.log(res)
              ready_to_go = false
            }
          })
          ...
          this.form_patent.year = this.form_patent.grant_date.substr(0,4);
      ...
      async get_student() { //搜索学生
        if (this.members_single.realName.trim() != '') {
          this.members_selected = await this.$api_user.get_user_by_name_old(0, this.members_single.realName.trim());
        } else {
          this.members_selected = [];
        }
      },
      async get_teacher() { //搜索教师
        if (this.teachers_single.realName.trim() != '') {
          this.teachers_selected = await this.$api_user.get_user_by_name_old(1, this.teachers_single.realName.trim());
        } else {
      ...
      /* set_projects() { //上传项目：在项目名称确定后，将该项目的作品类型存入中转数组
        var _this = this
        Object.keys(_this.projects).forEach(res => { //从项目数组中拉出一组列表，将作品类型用分隔符隔开存到各自数组
          if (_this.projects[res].name == _this.form_projects.name) {
            _this.projects_type = _this.projects[res].work_type.split("/")
          }
        })
      }, */
      ...
      set_doc_paper(fileObj){ //上传论文凭据材料
        this.if_uploading = true;
      ...
      add_members() { //将选定的成员信息压入成员列表
        ...
        Object.keys(this.members_single).forEach(res => {
          ...
          if (this.members_single[res] == '' && (res ==='realName'|| res === 'stu_class'||res === 'stid'|| res === 'phone') ) {
            console.log(res)
            ready_to_go = false
          }
        })
      ...
      add_teachers() { //将选定的教师信息压入成员列表
        let ready_to_go = true;
        console.log(this.teachers_single)
        Object.keys(this.teachers_single).forEach(res =>{
      ...
      let form = {}
        if (this.form_achievements.user_id == '') {
        ...
        this.axios.post('/diff/achieve/admin', form,{
              headers: {
                'Token': this.Token
              },
            })
        ...
        /* add_doc(){ //上传支撑材料
          this.axios.post('/support/upload?achieve_id='+this.achieve_id+'&type=0',this.formdata,{
              headers: {
                'Token': this.Token,
                'Content-Type': 'multipart/form-data'
              },
            ...
            .then(response => {
              if(response.data.code == 2000 && this.form_achievements.achieve_type!= '论文'){ //上传成功后跳出提示，返回上传首页，清空数据
              this.$message.success("上传成功!");
              this.if_loading = false;
              this.if_achievements = true;
            this.if_competition = false;
          ...
          this.teachers = [];
          this.achieve_id = '';
        }else if(response.data.code == 2000 && this.form_achievements.achieve_type == '论文'){
          this.add_doc_paper();
        }
            })
            .catch(
        ...
        add_doc_paper(){ //上传论文凭据
          this.axios.post('/support/upload?achieve_id='+this.achieve_id+'&type=5',this.formdata_paper,{
              headers: {
                'Token': this.Token,
                'Content-Type': 'multipart/form-data'
              },
