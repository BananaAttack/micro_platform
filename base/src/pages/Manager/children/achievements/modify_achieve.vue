    ...
    <div v-loading="if_loading">
        ...
        @click="$router.back(-1)"></i>
                    ...
                    <el-form width="500px">
                        ...
                        <el-form-item label="竞赛名称" :label-width="formLabelWidth">
                            <el-select v-model="info.competition_name" placeholder="选择竞赛名称" @change="set_competition"
                                style="width: 400px;">
                                <el-option v-for="item in competition" :key="item.id" :label="item.name"
                                    :value="item.name">
                                </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="年份" :label-width="formLabelWidth" style="width: 400px;">
                        ...
                        <el-form-item label="公布获奖日期" :label-width="formLabelWidth">
                            <el-date-picker v-model="info.award_date" type="date" placeholder="选择获奖日期"
                                format="yyyy-MM-dd">
                            </el-date-picker>
                        </el-form-item>
                        <el-form-item label="作品类型" :label-width="formLabelWidth">
                            <el-select v-model="info.workType" @change="$forceUpdate()" placeholder="选择作品类型"
                                style="width: 400px;">
                                <el-option v-for="(item,i) in options_workType" :key="i" :label="item" :value="item">
                                </el-option>
                            </el-select>
                        </el-form-item>
                    ...
                    <el-form width="500px">
                        ...
                        <el-form-item label="项目名称" :label-width="formLabelWidth">
                            <el-select v-model="info.name" placeholder="选择项目名称" style="width: 400px;"
                                ...
                                <el-option v-for="(item,i) in projects" :key="i" :label="item.name" :value="item.name">
                                </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="作品类型" :label-width="formLabelWidth">
                    ...
                    <el-form width="500px">
                        ...
                        <el-form-item label="检索凭证" :label-width="formLabelWidth">
                            <div style="display: inline-block;overflow: hidden;">
                                ...
                                <el-link type="primary" v-if="info.support_files !== null"
                                    style="display: inline;margin-left: 25px;font-size: 16px;" @click="view_file_paper">
                                    预览</el-link>
                                <el-link type="primary" v-if="info.support_files !== null"
                                    style="display: inline;margin-left: 25px;font-size: 16px;"
                                    @click="download_file_paper">下载</el-link>
                ...
                <div style="margin-top: 30px;">
                    <el-form width="500px">
                        ...
                        <el-form-item label="知识产权类型" :label-width="formLabelWidth">
                            <el-select v-model="info.patent_type" placeholder="选择知识产权等级" style="width: 400px;"
                                @change="set_paper_rank">
            ...
            <div v-if="if_members">
                ...
                <el-button type="primary" style="width: 120px;margin-left: 300px;margin-top: 30px;"
                    @click="add_achievement">保存
                </el-button>
                <el-button class="back-el-button" type="primary" @click="goBack"
                    style="width: 120px;margin-top: 30px;margin-left: 30px;">返回上一步</el-button>
            </div>
            ...
            <el-dialog title="添加指导老师" :visible.sync="visible_add_teachers" width="500px" @open="cleanAll_teachers">
                <el-form @submit.native.prevent>
                    <el-form-item label="学院" :label-width="formLabelWidth">
        ...
        methods: {
            ...
            async get_competition_single() {
                await this.axios
                    ...
                    .then((response) => {
                        ...
                        this.info.workType = response.data.data.work_type;
                    })
            ...
            async get_projects_single() {
                await this.axios
                    ...
                    .then((response) => {
                        ...
                        this.get_projects();
                        this.info.work_type = response.data.data.work_type;
                    })
                    .catch(function (response) {
                        console.log(response);
                    });
            ...
            goNext() { //进入第二页
                ...
                Object.keys(this.info).forEach(res => {
                    if (this.info[res] === '' && res != 'status' && res != 'teachers' && res != 'students' && res != 'achieve_type' && res != 'type' && res != 'paper_level_value' && res != 'pno') {
                        ready_to_go = false
                        console.log(res)
                    }
                })
