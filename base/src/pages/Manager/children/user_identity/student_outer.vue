    ...
    <div style="display: flex;justify-content: center;align-items: center;flex-direction: column;">
        <div style="width: 100%;min-width: 800px;">
            <div style="margin-top: 10px;">
                ...
                <el-input v-if="type_selected == 'stu_class'" @change="set_value" @keyup.enter.native="getData"
                    v-model="select.class_selected" placeholder="搜索班级" style="width: 150px;margin-left: 20px;">
                </el-input>
            ...
            <div>
                <el-table ref="multipleTable" :data="info" size="small" stripe tooltip-effect="dark"
                    ...
                    <el-table-column prop="realName" :formatter="if_null" label="姓名" show-overflow-tooltip width="150"
                        align="center">
                    </el-table-column>
                    <el-table-column prop="stid" :formatter="if_null" label="学号" show-overflow-tooltip align="center">
                    </el-table-column>
                    <el-table-column prop="stu_class" :formatter="if_null" label="班级" show-overflow-tooltip
                        align="center">
                    </el-table-column>
                    <el-table-column prop="phone" :formatter="if_null" label="联系方式" show-overflow-tooltip
                        align="center">
                    </el-table-column>
